    ...
    public double evaluar(Funcion funcion, double a, double b, int n) {
        ...
        for (int k = 1; k < n; k++) {
            ...
            for (int j = 0; j < (n - k); j++) {
                ...
                System.out.println("Mayor[" + (j + 1) + "][" + (k - 1) + "]=(" + potencia + " / (" + (potencia - 1) + ")) * " + this.redondear(matriz[j + 1][k - 1]) + " = " + mayor);
                System.out.println("Menor[" + j + "][" + (k - 1) + "]=(" + 1 + " / (" + (potencia - 1) + ")) * " + this.redondear(matriz[j][k - 1]) + " = " + menor);
                System.out.println("");
                System.out.println("matriz[" + j + "][" + k + "]=" + mayor + " - " + menor);
                System.out.println("--------------------------------------------");
